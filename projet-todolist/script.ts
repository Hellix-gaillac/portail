window.addEventListener("load", function(event) {
  ...
  buttonUserName.addEventListener('click', function() {//reagir au click

    let valueInputUserName = (document.querySelector('#userName') as HTMLInputElement).value;//recuperer value de input
